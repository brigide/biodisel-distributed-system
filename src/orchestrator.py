...
class Orchestrator:
    def __init__(self):
        ...
        self.conns['Emulsion'] = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    ...
    def addConns(self):
        ...
        self.addConn('Emulsion', ports.Emulsion.Host(), ports.Emulsion.Port())
    ...
    def getComponentReports(self):
        ...
        reactor = self.getReport('Reactor')
        self.printReport(reactor)
        decanter = self.getReport('Decanter')
        self.printReport(decanter)
        ...
        emulsion = self.getReport('Emulsion')
        ...
        print(round(glycerin['substances']['Glycerin'], 2))
        print('Emulsion generated: '.ljust(10), end='')
        print(round(emulsion['substances']['Emulsion'], 2))
        print('Biodiesel generated: '.ljust(10), end='')
        print(round(biodiesel['substances']['Biodiesel'], 2))

        print('Reactor cycles: '.ljust(10), end='')
        print(reactor['cycles'])

        print('Decanter cycles: '.ljust(10), end='')
        print(decanter['cycles'])
